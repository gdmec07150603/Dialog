...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et1 =(TextView) findViewById(R.id.uidate);
        et2 =(TextView) findViewById(R.id.uitime);
        et3 =(TextView) findViewById(R.id.charactor);

    }
    public void charactordialog(View v){
        final String option=et1.getText().toString();
        CharacterPickerDialog cpd = new CharacterPickerDialog(this,new View(this),null,option,false){
            @Override
            public void onClick(View v) {
                Button btn =(Button) v;
                et1.append(btn.getText().toString());
